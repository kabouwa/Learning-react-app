...
export default function Header() {
    ...
    return (
        <motion.header transition={{ ease : 'easeInOut', delay : 0.2 }} initial={{ x : '50vw' }} animate={{ x : 0 }}

            className="sticky md:min-h-16 h-22 md:h-16 top-0 z-50 w-full bg-gray-100 dark:bg-gray-800/75 flex flex-col md:flex-row justify-between 
