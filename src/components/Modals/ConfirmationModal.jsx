...
export default function ConfirmationModal() {
    ...
    return (
        <div id="confirm-modal" 
            ...
            <div className="dark:bg-gray-700 bg-gray-100 w-full md:w-1/2 max-w-lg min-h-50 rounded-2xl p-4 animate-fade-in-to-top">
                ...
                <main className="my-4 md:my-8 text-gray-500 dark:text-gray-300 px-2">
                    <p>
                        {description}
                    </p>
                </main>
                ...
                <footer className="flex items-center justify-end gap-2.5">
                    <button type="button" onClick={() => {setShowModal(false)}}
                        className="py-2 px-1.5 md:px-4.5 rounded-2 text-gray-600 dark:text-gray-200 flex-1 md:flex-0 flex justify-center items-center gap-2 transition-all ring ring-gray-300 hover:shadow-md shadow-gray-400 "
                    ><X /> Cancel
                    </button>
